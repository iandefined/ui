---
title: Field
description: An accessible field composition primitive for labels, descriptions, validation state, and errors.
---
...
<ApiPropsList>
  <ApiProp fullType="boolean" name="dirty">
  ...
  <ApiProp fullType="string" name="name">
    Identifies the field for label and message association.
  </ApiProp>
  <ApiProp fullType="boolean" name="touched">
...
<ApiPropsList>
  <ApiProp defaultValue="false" fullType="boolean" name="match">
