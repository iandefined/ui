...
Submit an incomplete or unavailable date to mark the segmented input invalid. Completing a permitted date clears the error without shaking during segment edits.
