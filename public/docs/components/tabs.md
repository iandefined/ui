...
Every tab variant supports `sm`, `default`, and `lg` to match the sizing of `Input` controls in the same form.
...
| :--- | :--- | :--- | :--- |
| `size` | `"sm" \| "default" \| "lg"` | `default` | Sets the size of the tab triggers. |
...
| Prop | Type | Default | Description |
| :--- | :--- | :--- | :--- |
| `size` | `"sm" \| "default" \| "lg"` | `-` | Overrides the size inherited from `Tabs`. |
