...
Pass children to `Separator` to place content between two divider hairlines. Use
`Separator.Root` and `Separator.Content` when you want the Base UI-style compound
syntax and a dedicated styling slot.
...
export default function SeparatorContentDemo() {
  return (
    <div className="grid w-full max-w-lg gap-8">
      <Separator.Root>
        <Separator.Content className="text-xs text-border">
          Continue with
        </Separator.Content>
      </Separator.Root>

      <Separator.Root>
        <Separator.Content className="rounded-lg border border-border bg-background px-3 py-1 text-sm">
          Label
        </Separator.Content>
      </Separator.Root>

      <Separator.Root>
        <Separator.Content className="flex overflow-hidden rounded-lg border border-border bg-background p-0 text-sm">
          <span className="border-e border-border px-3 py-2">Label</span>
          <span className="border-e border-border px-3 py-2">Label</span>
          <span className="border-e border-border px-3 py-2">Label</span>
...
| `children` | `ReactNode` | `-` | Renders centered content between two separator hairlines. |
