...
Submit a value below the required threshold to mark the slider invalid. Dragging revalidates without shaking, and the error clears as soon as the threshold is met.
