...
Submit an incomplete website address to mark the whole input group invalid. Correction clears the error when the hostname is valid, while another failed submission replays the shake.
