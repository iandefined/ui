...
const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      outline:
        "border bg-background shadow-xs hover:bg-accent active:bg-accent/80 hover:text-accent-foreground aria-expanded:bg-accent aria-expanded:text-accent-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50 dark:aria-expanded:bg-input/50 dark:active:bg-input/40",
      ghost:
        "text-primary hover:bg-primary/10 active:bg-primary/5 aria-expanded:bg-primary/10 focus-vislbe:bg-primary/10 focus-visible:border-primary/25",
