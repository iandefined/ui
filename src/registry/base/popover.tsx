...
const animationPresets: Record<PopoverAnimationPreset, string> = {
  ...
  slideInside:
    "[transition-property:translate,opacity] [will-change:translate,opacity] data-[side=bottom]:data-starting-style:opacity-0 data-[side=bottom]:data-starting-style:translate-y-[-10px] data-[side=bottom]:data-ending-style:translate-y-[-10px] data-[side=bottom]:data-ending-style:opacity-0 data-[side=top]:data-starting-style:opacity-0 data-[side=top]:data-starting-style:translate-y-[10px] data-[side=top]:data-ending-style:translate-y-[10px] data-[side=top]:data-ending-style:opacity-0 data-[side=left]:data-starting-style:opacity-0 data-[side=left]:data-starting-style:translate-x-[10px] data-[side=left]:data-ending-style:translate-x-[10px] data-[side=left]:data-ending-style:opacity-0 data-[side=right]:data-starting-style:opacity-0 data-[side=right]:data-starting-style:translate-x-[-10px] data-[side=right]:data-ending-style:translate-x-[-10px] data-[side=right]:data-ending-style:opacity-0 data-[side=inline-start]:data-starting-style:opacity-0 data-[side=inline-start]:data-starting-style:translate-x-[10px] data-[side=inline-start]:data-ending-style:translate-x-[10px] data-[side=inline-start]:data-ending-style:opacity-0 data-[side=inline-end]:data-starting-style:opacity-0 data-[side=inline-end]:data-starting-style:translate-x-[-10px] data-[side=inline-end]:data-ending-style:translate-x-[-10px] data-[side=inline-end]:data-ending-style:opacity-0",
  wipe: "[transition-property:clip-path] [will-change:clip-path] [clip-path:inset(-2px_-2px_-2px_-2px_round_12px)] [-webkit-clip-path:inset(-2px_-2px_-2px_-2px_round_12px)] data-[side=bottom]:data-starting-style:[clip-path:inset(-2px_-2px_calc(100%_+_2px)_-2px_round_12px)] data-[side=bottom]:data-ending-style:[clip-path:inset(-2px_-2px_calc(100%_+_2px)_-2px_round_12px)] data-[side=top]:data-starting-style:[clip-path:inset(calc(100%_+_2px)_-2px_-2px_-2px_round_12px)] data-[side=top]:data-ending-style:[clip-path:inset(calc(100%_+_2px)_-2px_-2px_-2px_round_12px)] data-[side=left]:data-starting-style:[clip-path:inset(-2px_-2px_-2px_calc(100%_+_2px)_round_12px)] data-[side=left]:data-ending-style:[clip-path:inset(-2px_-2px_-2px_calc(100%_+_2px)_round_12px)] data-[side=right]:data-starting-style:[clip-path:inset(-2px_calc(100%_+_2px)_-2px_-2px_round_12px)] data-[side=right]:data-ending-style:[clip-path:inset(-2px_calc(100%_+_2px)_-2px_-2px_round_12px)] data-[side=inline-start]:data-starting-style:[clip-path:inset(-2px_-2px_-2px_calc(100%_+_2px)_round_12px)] data-[side=inline-start]:data-ending-style:[clip-path:inset(-2px_-2px_-2px_calc(100%_+_2px)_round_12px)] data-[side=inline-end]:data-starting-style:[clip-path:inset(-2px_calc(100%_+_2px)_-2px_-2px_round_12px)] data-[side=inline-end]:data-ending-style:[clip-path:inset(-2px_calc(100%_+_2px)_-2px_-2px_round_12px)]",
  wipeScale:
    "[transition-property:clip-path,scale] [will-change:clip-path,scale] [clip-path:inset(-2px_-2px_-2px_-2px_round_12px)] [-webkit-clip-path:inset(-2px_-2px_-2px_-2px_round_12px)] data-starting-style:scale-80 data-ending-style:scale-80 data-[side=bottom]:data-starting-style:[clip-path:inset(-2px_-2px_calc(100%_+_2px)_-2px_round_12px)] data-[side=bottom]:data-ending-style:[clip-path:inset(-2px_-2px_calc(100%_+_2px)_-2px_round_12px)] data-[side=top]:data-starting-style:[clip-path:inset(calc(100%_+_2px)_-2px_-2px_-2px_round_12px)] data-[side=top]:data-ending-style:[clip-path:inset(calc(100%_+_2px)_-2px_-2px_-2px_round_12px)] data-[side=left]:data-starting-style:[clip-path:inset(-2px_-2px_-2px_calc(100%_+_2px)_round_12px)] data-[side=left]:data-ending-style:[clip-path:inset(-2px_-2px_-2px_calc(100%_+_2px)_round_12px)] data-[side=right]:data-starting-style:[clip-path:inset(-2px_calc(100%_+_2px)_-2px_-2px_round_12px)] data-[side=right]:data-ending-style:[clip-path:inset(-2px_calc(100%_+_2px)_-2px_-2px_round_12px)] data-[side=inline-start]:data-starting-style:[clip-path:inset(-2px_-2px_-2px_calc(100%_+_2px)_round_12px)] data-[side=inline-start]:data-ending-style:[clip-path:inset(-2px_-2px_-2px_calc(100%_+_2px)_round_12px)] data-[side=inline-end]:data-starting-style:[clip-path:inset(-2px_calc(100%_+_2px)_-2px_-2px_round_12px)] data-[side=inline-end]:data-ending-style:[clip-path:inset(-2px_calc(100%_+_2px)_-2px_-2px_round_12px)]",
  motion:
