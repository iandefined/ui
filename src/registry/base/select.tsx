  ...
  return (
    <SelectPrimitive.Value
      ...
      render={(renderProps, state) => {
        ...
        const isNull = newValue == null && !renderProps.children;
...
function SelectIcon({ className, ...props }: SelectIconProps) {
  return (
    <SelectPrimitive.Icon
      ...
      className={cn(
        "inline-flex size-3.5 shrink-0 items-center justify-center text-foreground/72 leading-none [&>svg]:size-full",
        className
      )}
      {...props}
    />
...
type SelectPortalProps = {} & React.ComponentProps<
...
type SelectBackdropProps = {} & React.ComponentProps<
          ...
          if (alignItemWithTrigger) {
            return (
              <div
                ...
                {...renderProps}
                className={cn(
                  "pointer-events-auto data-ending-style:pointer-events-none origin-(--transform-origin)",
                  className
                )}
                style={{
                  ...renderProps.style,
